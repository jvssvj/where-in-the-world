...
/***/ "./src/scripts/features/render/renderCountryClicked.ts":
/*!*************************************************************!*\
  !*** ./src/scripts/features/render/renderCountryClicked.ts ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   renderCountryClicked: () => (/* binding */ renderCountryClicked)\n/* harmony export */ });\n/* harmony import */ var _api_getCountries__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../api/getCountries */ \"./src/scripts/api/getCountries.ts\");\n/* harmony import */ var _state_globalData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../state/globalData */ \"./src/scripts/state/globalData.ts\");\n/* harmony import */ var _animation_animations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../animation/animations */ \"./src/scripts/features/animation/animations.ts\");\n/* harmony import */ var _interaction_showOverview__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../interaction/showOverview */ \"./src/scripts/features/interaction/showOverview.ts\");\n/* harmony import */ var _navigation_currentCountry__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../navigation/currentCountry */ \"./src/scripts/features/navigation/currentCountry.ts\");\n/* harmony import */ var _renderDetailsCountry__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./renderDetailsCountry */ \"./src/scripts/features/render/renderDetailsCountry.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\n\n\n\nfunction renderCountryClicked(countryName) {\n    return __awaiter(this, void 0, void 0, function* () {\n        var _a;\n        const data = yield (0,_api_getCountries__WEBPACK_IMPORTED_MODULE_0__.getCountries)(`name/${countryName}`);\n        if (!data || data.length === 0)\n            return;\n        const country = data[0];\n        const countrieFlag = country.flags.svg;\n        const countrieName = country.name.common;\n        const countrieNativeName = country.name.official;\n        const countriePopulation = country.population.toLocaleString('en-US');\n        const countrieRegion = country.region;\n        const countrieSubRegion = country.subregion;\n        const countrieCapital = country.capital;\n        const countrieTopLevelDomain = country.tld;\n        const currencies = country.currencies;\n        const countrieCurrencies = currencies\n            ? ((_a = Object.values(currencies)[0]) === null || _a === void 0 ? void 0 : _a.name) || ''\n            : '';\n        const languages = country.languages;\n        const countrieLanguages = languages ? Object.values(languages).join(', ') : '';\n        const countryBorders = country.borders || [];\n        const allCountries = (0,_state_globalData__WEBPACK_IMPORTED_MODULE_1__.getAllCountries)();\n        const countryCode = country.cca3;\n        const countrieBorders = countryBorders\n            .filter((code) => code !== countryCode)\n            .map((code) => { var _a; return (_a = allCountries.find(c => c.cca3 === code)) === null || _a === void 0 ? void 0 : _a.name.common; })\n            .filter(Boolean);\n        (0,_interaction_showOverview__WEBPACK_IMPORTED_MODULE_3__.showOverview)();\n        (0,_renderDetailsCountry__WEBPACK_IMPORTED_MODULE_5__.renderDetailsCountry)(countrieFlag, countrieName, countrieNativeName, countriePopulation, countrieRegion, countrieSubRegion, countrieCapital, countrieTopLevelDomain, countrieCurrencies, countrieLanguages, countrieBorders);\n        (0,_navigation_currentCountry__WEBPACK_IMPORTED_MODULE_4__.currentCountry)();\n        (0,_animation_animations__WEBPACK_IMPORTED_MODULE_2__.initCountryDetailsReveal)();\n    });\n}\n\n\n//# sourceURL=webpack://rest-countries-api/./src/scripts/features/render/renderCountryClicked.ts?");
...
/***/ "./src/scripts/features/render/renderSpecificCountries.ts":
/*!****************************************************************!*\
  !*** ./src/scripts/features/render/renderSpecificCountries.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   renderSpecificCountries: () => (/* binding */ renderSpecificCountries)\n/* harmony export */ });\n/* harmony import */ var _api_getCountries__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../api/getCountries */ \"./src/scripts/api/getCountries.ts\");\n/* harmony import */ var _animation_animations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../animation/animations */ \"./src/scripts/features/animation/animations.ts\");\n/* harmony import */ var _navigation_currentCountry__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../navigation/currentCountry */ \"./src/scripts/features/navigation/currentCountry.ts\");\n/* harmony import */ var _renderCountries__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./renderCountries */ \"./src/scripts/features/render/renderCountries.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\n\nfunction renderSpecificCountries() {\n    return __awaiter(this, void 0, void 0, function* () {\n        const data = yield (0,_api_getCountries__WEBPACK_IMPORTED_MODULE_0__.getCountries)();\n        const specificCountries = [\"Germany\", \"United States\", \"Brazil\", \"Iceland\", \"Afghanistan\", \"Åland Islands\", \"Albania\", \"Algeria\"];\n        const countriesMap = new Map();\n        data.forEach((country) => {\n            countriesMap.set(country.name.common, country);\n        });\n        specificCountries.forEach((countryName) => {\n            const country = countriesMap.get(countryName);\n            if (country) {\n                const flag = country.flags.svg;\n                const name = country.name.common;\n                const population = country.population.toLocaleString('en-US');\n                const region = country.region;\n                const capital = country.capital;\n                (0,_renderCountries__WEBPACK_IMPORTED_MODULE_3__.renderCountries)(flag, name, population, region, capital);\n            }\n        });\n        (0,_navigation_currentCountry__WEBPACK_IMPORTED_MODULE_2__.countryClicked)();\n        (0,_animation_animations__WEBPACK_IMPORTED_MODULE_1__.initCountriesReveal)();\n    });\n}\n\n\n//# sourceURL=webpack://rest-countries-api/./src/scripts/features/render/renderSpecificCountries.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _features_interaction_openAndCloseFilters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./features/interaction/openAndCloseFilters */ \"./src/scripts/features/interaction/openAndCloseFilters.ts\");\n/* harmony import */ var _features_interaction_theme__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./features/interaction/theme */ \"./src/scripts/features/interaction/theme.ts\");\n/* harmony import */ var _features_navigation_searchCountry__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./features/navigation/searchCountry */ \"./src/scripts/features/navigation/searchCountry.ts\");\n/* harmony import */ var _features_navigation_selectRegion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./features/navigation/selectRegion */ \"./src/scripts/features/navigation/selectRegion.ts\");\n/* harmony import */ var _features_render_renderSpecificCountries__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./features/render/renderSpecificCountries */ \"./src/scripts/features/render/renderSpecificCountries.ts\");\n/* harmony import */ var _features_interaction_clearFilters__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./features/interaction/clearFilters */ \"./src/scripts/features/interaction/clearFilters.ts\");\n/* harmony import */ var _features_animation_animations__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./features/animation/animations */ \"./src/scripts/features/animation/animations.ts\");\n/* harmony import */ var _assets_styles_components_country_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../assets/styles/components/country.css */ \"./src/assets/styles/components/country.css\");\n/* harmony import */ var _assets_styles_components_nav_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../assets/styles/components/nav.css */ \"./src/assets/styles/components/nav.css\");\n/* harmony import */ var _assets_styles_components_header_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../assets/styles/components/header.css */ \"./src/assets/styles/components/header.css\");\n/* harmony import */ var _assets_styles_pages_index_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../assets/styles/pages/index.css */ \"./src/assets/styles/pages/index.css\");\n/* harmony import */ var _assets_styles_pages_overviewCountry_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../assets/styles/pages/overviewCountry.css */ \"./src/assets/styles/pages/overviewCountry.css\");\n/* harmony import */ var _assets_styles_state_state_css__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../assets/styles/state/state.css */ \"./src/assets/styles/state/state.css\");\n/* harmony import */ var _assets_styles_utils_animations_css__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../assets/styles/utils/animations.css */ \"./src/assets/styles/utils/animations.css\");\n/* harmony import */ var _assets_styles_utils_reset_css__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../assets/styles/utils/reset.css */ \"./src/assets/styles/utils/reset.css\");\n/* harmony import */ var _assets_styles_utils_variables_css__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../assets/styles/utils/variables.css */ \"./src/assets/styles/utils/variables.css\");\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n(0,_features_interaction_theme__WEBPACK_IMPORTED_MODULE_1__.changeTheme)();\n(0,_features_interaction_openAndCloseFilters__WEBPACK_IMPORTED_MODULE_0__.openAndCloseFilters)();\n(0,_features_interaction_clearFilters__WEBPACK_IMPORTED_MODULE_5__.clearFilters)();\n(0,_features_navigation_searchCountry__WEBPACK_IMPORTED_MODULE_2__.searchCountry)();\n(0,_features_navigation_selectRegion__WEBPACK_IMPORTED_MODULE_3__.selectRegion)();\n(0,_features_render_renderSpecificCountries__WEBPACK_IMPORTED_MODULE_4__.renderSpecificCountries)();\n(0,_features_animation_animations__WEBPACK_IMPORTED_MODULE_6__.initUIReveal)();\n\n\n//# sourceURL=webpack://rest-countries-api/./src/scripts/index.ts?");
